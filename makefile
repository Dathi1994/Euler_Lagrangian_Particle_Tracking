...
EIGEN_CPPFLAGS = -I/home/dathi/software/eigen
...
vtk:	vtk_vis.o
	mpicxx -o vtk vtk_vis.o ${PETSC_LIB} ${LIBFLAG}
...
vtk_a:	
	mpicxx -c -o vtk_vis.o -DNDEBUG ${PETSCINC_AEGEAN} -I/usr/include -O3 -MMD -MP vtk_vis.c
